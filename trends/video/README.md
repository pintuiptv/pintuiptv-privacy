...
Direct rankings (`trakt_official`) preserve Trakt ordering: trending, popular, weekly watched, and anticipated. Composite Pintu rankings (`pintu_composite`) include new releases, Bayesian top-rated, movies of the year, and shows of the moment. Trakt supplies data only and does not provide video content or user playlists. Pintu Player is not sponsored, endorsed, or certified by Trakt.
